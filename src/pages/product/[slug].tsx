...
const DetailProduct = () => {
  ...
  const { data: products, isLoading } = useQuery(
    ["detail-product"],
    () => {
      const promise = fetchDetailProduct(slug);
  ...
  const rating = products?.data?.rating as number;

  return (
    <main>
      <section className="text-gray-700 body-font overflow-hidden bg-white">
        <Seo templateTitle={`${products?.data?.name || "Product not found"}`} />
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">{products?.data.description}</p>
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900">
                  <Currency
                    quantity={products?.data.price || 0}
                    currency="IDR"
                  />
                </span>
                <Button
